                            ...
                            <tr tabIndex={0} className="focus:outline-none h-16 border border-gray-100 rounded">
                                <td>
                                    <div className="flex ml-5">
                                            <p className="text-base font-medium leading-none text-gray-700 mr-2">#DC-1231</p>
                                ...
                                <td className="">
                                    <div className="flex items-center pl-5">
                                        <p className="text-base font-medium leading-none text-gray-700 mr-2">Peru, IL</p>
                                ...
                                <td className="pl-24">
                                    <div className="flex items-center">
                                        <p className="text-sm leading-none text-gray-600 ml-2"><b>PU:</b> 04/07/2022</p>
                                    </div>
                                </td>
                                <td className="pl-5">
                                    <div className="flex items-center">c
                                        <p className="text-sm leading-none text-gray-600 ml-2"><b>TRUCK:</b> F</p>
                                    </div>
                                </td>
                                <td className="pl-5">
                                    <div className="flex items-center">
                                        <p className="text-sm leading-none text-gray-600 ml-2"><b>Rate: </b>$1200</p>
                                    </div>
                                </td>
                                <td className="pl-5">
                                ...
                                <td className="pl-5">
                                    ...
                                    <div className="flex items-center">
                                        <p className="text-sm leading-none text-gray-600 ml-2"><b>Submissions: </b>23</p>
