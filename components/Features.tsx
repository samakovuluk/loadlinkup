            ...
            <section id="features" className="bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div className="max-w-screen-md mb-8 lg:mb-16">
                        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Elevate Your Shipping with Carrierify</h2>
                        <p className="text-gray-500 sm:text-xl dark:text-gray-400">Our platform is here to help brokers soar to new heights in the world of shipping. With just a few clicks, you can find the best carriers for your loads and streamline key processes. Here are a few of the features that make Carrierify the ultimate tool for logistics success.</p>
                    </div>
                    <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                        <div>
                            ...
                            <p className="text-gray-500 dark:text-gray-400">With just a few clicks, brokers can store information about their loads and generate a link to share with carriers.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Top carriers</h3>
                            <p className="text-gray-500 dark:text-gray-400">Carrierify makes it easy to find the best carriers for your loads, based on price, pickup times, and other factors.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">You can customize the form that carriers fill out when they submit their prices and pickup times, to ensure that you get the information you need.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Our platform is secure and protects your information.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Receive notifications when carriers submit their prices and pickup times for your loads.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Automation</h3>
                            <p className="text-gray-500 dark:text-gray-400">Carrierify integrates with other logistics systems and automates key processes, making it easy to manage all of your shipping needs in one place.</p>
                        </div>
                    </div>
                </div>
            </section>
